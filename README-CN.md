...
| MacOS  | Windows | Linux |
| ------------- | ------------- | ------------- |
| [Mac Intel](https://github.com/thinkingjimmy/PoleStarChat/releases/download/V0.0.12/PoleStarChat_x86_v0.0.12_zh_CN.dmg) · [Mac M1/M2](https://github.com/thinkingjimmy/PoleStarChat/releases/download/V0.0.12/PoleStarChat_arm64_v.0.0.12_zh_CN.dmg) | 敬请期待 | 敬请期待 |
